...
function itsAGirl_post_image_html( $html, $post_id, $post_image_id ) {
	...
	$html = '<div class="itsAGirl-post-thumbnail" style="background: url(' . wp_get_attachment_image_src( get_post_thumbnail_id($post_id) )['0'] . ') no-repeat center center;background-size: cover"><div class="itsAGirl-post-thumbnail-inner">' . $html . '</div></div>';
